...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('webaffe_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('webaffe_profile', JSON.stringify(profileStore.get()));
  }
};
